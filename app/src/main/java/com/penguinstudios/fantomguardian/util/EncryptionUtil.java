...
/*
 * This utility class is based on the Secure Compatible Encryption Examples project
 * by Luke Park (https://github.com/luke-park/SecureCompatibleEncryptionExamples).
 */
public class EncryptionUtil {
    ...
    public static String encryptString(String plaintext, String password) throws NoSuchAlgorithmException,
    ...
    public static byte[] decrypt(byte[] ciphertextAndNonce, byte[] key) throws InvalidKeyException,
